...
class ToolWalletTest(WidecoinTestFramework):
    ...
    def widecoin_wallet_process(self, *args):
        ...
        return subprocess.Popen([self.options.widecoinwallet] + default_args + list(args), stdin=subprocess.PIPE, stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True)
