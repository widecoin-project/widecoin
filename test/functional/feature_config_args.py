...
class ConfArgsTest(WidecoinTestFramework):
    ...
    def test_config_file_parser(self):
        ...
        bad_conf_file_path = os.path.join(self.options.tmpdir, 'node0', 'widecoin_bad.conf')
    ...
    def run_test(self):
        ...
        none_existent_conf_file = os.path.join(default_data_dir, "none_existent_widecoin.conf")
