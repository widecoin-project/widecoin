...
class TestShell:
    """Wrapper Class for WidecoinTestFramework.

    The TestShell class extends the WidecoinTestFramework
    ...
    class __TestShell(WidecoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by WidecoinTestFramework child class.
            self.num_nodes = 1
