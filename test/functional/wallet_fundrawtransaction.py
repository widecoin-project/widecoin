...
class RawTransactionsTest(WidecoinTestFramework):
    ...
    def test_input_confs_control(self):
        ...
        # Create a replacement tx to 'final_tx1' that has 1 WCN target instead of 0.1.
        ...
        # Now fund 'raw_tx2' to fulfill the total target (1 WCN) by using all the wallet unconfirmed outputs.
        # As it was created with the first unconfirmed output, 'raw_tx2' only has 0.1 WCN covered (need to fund 0.9 WCN more).
