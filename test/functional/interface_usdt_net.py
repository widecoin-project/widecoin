...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/widecoin/widecoin/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(WidecoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our widecoind node")
