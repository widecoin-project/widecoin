...
- Create widecoinds that connect to them
- Manipulate the widecoinds using addnode (onetry) an observe effects
...
class ProxyTest(WidecoinTestFramework):
    ...
    def node_test(self, node, proxies, auth, test_onion=True):
        ...
        if test_onion:
            ...
            node.addnode("widecoinostk4e4re.onion:8333", "onetry")
