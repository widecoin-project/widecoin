...
By default, widecoind will dump mempool on shutdown and
...
class MempoolPersistTest(WidecoinTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(2)
        # Give widecoind a second to reload the mempool
        ...
        self.log.debug("Prevent widecoind from writing mempool.dat to disk. Verify that `savemempool` fails")
