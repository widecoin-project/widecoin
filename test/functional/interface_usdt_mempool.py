...
"""  Tests the mempool:* tracepoint API interface.
     See https://github.com/widecoin/widecoin/blob/master/doc/tracing.md#context-mempool
"""
...
class MempoolTracepointTest(WidecoinTestFramework):
    ...
    def rejected_test(self):
        ...
        # https://github.com/widecoin/widecoin/issues/27380
