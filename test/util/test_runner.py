...
def bctest(testDir, testObj, buildenv):
    ...
    if testObj["exec"] == "./widecoin-util":
        execprog = os.getenv("WIDECOINUTIL", default=execprog)
    elif testObj["exec"] == "./widecoin-tx":
        execprog = os.getenv("WIDECOINTX", default=execprog)
