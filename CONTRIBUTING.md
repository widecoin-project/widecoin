Contributing to Widecoin Core
============================

The Widecoin Core project operates an open contributor model where anyone is
welcome to contribute towards development in the form of peer review, testing
and patches. This document explains the practical process and guidelines for
contributing.

First, in terms of structure, there is no particular concept of "Widecoin Core
...
Before you start contributing, familiarize yourself with the Widecoin Core build
system and tests. Refer to the documentation in the repository on how to build
Widecoin Core and how to run the unit tests, functional tests, and fuzz tests.
...
[Widecoin Core PR Review Club](https://widecoincore.reviews/) meeting.
...
Most communication about Widecoin Core development happens on IRC, in the
`#widecoin-core-dev` channel on Freenode. The easiest way to participate on IRC is
with the web client, [webchat.freenode.net](https://webchat.freenode.net/). Chat
history logs can be found
on [http://www.erisian.com.au/widecoin-core-dev/](http://www.erisian.com.au/widecoin-core-dev/)
and [http://gnusha.org/widecoin-core-dev/](http://gnusha.org/widecoin-core-dev/).

Discussion about codebase improvements happens in GitHub issues and pull
requests.

The developer
[mailing list](https://lists.linuxfoundation.org/mailman/listinfo/widecoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to widecoin-qt
...
fork of Widecoin Core copies the merge. Instead, make any username mentions in a
...
The following applies to code changes to the Widecoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Widecoin
Network Protocol consensus changes.

Whether a pull request is merged into Widecoin Core rests with the project merge
...
Patches that change Widecoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Widecoin consensus, it must have been
...
The project leader is the release manager for each Widecoin Core release.
