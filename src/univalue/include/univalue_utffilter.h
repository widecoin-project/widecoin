...
#ifndef WIDECOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
#define WIDECOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
...
#endif // WIDECOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
