...
QT_TRANSLATE_NOOP("widecoin-core", "Block verification was interrupted"),
...
QT_TRANSLATE_NOOP("widecoin-core", "Error reading configuration file: %s"),
...
QT_TRANSLATE_NOOP("widecoin-core", "Error: Cannot extract destination from the generated scriptpubkey"),
...
QT_TRANSLATE_NOOP("widecoin-core", "Failed to start indexes, shutting down.."),
...
QT_TRANSLATE_NOOP("widecoin-core", "Insufficient dbcache for block verification"),
...
QT_TRANSLATE_NOOP("widecoin-core", "Invalid amount for %s=<amount>: '%s' (must be at least %s)"),
...
QT_TRANSLATE_NOOP("widecoin-core", "Invalid port specified in %s: '%s'"),
QT_TRANSLATE_NOOP("widecoin-core", "Invalid pre-selected input %s"),
...
QT_TRANSLATE_NOOP("widecoin-core", "Not found pre-selected input %s"),
QT_TRANSLATE_NOOP("widecoin-core", "Not solvable pre-selected input %s"),
...
QT_TRANSLATE_NOOP("widecoin-core", "Settings file could not be read"),
QT_TRANSLATE_NOOP("widecoin-core", "Settings file could not be written"),
...
QT_TRANSLATE_NOOP("widecoin-core", "Specified data directory \"%s\" does not exist."),
...
QT_TRANSLATE_NOOP("widecoin-core", "Unsupported global logging level %s=%s. Valid values: %s."),
...
QT_TRANSLATE_NOOP("widecoin-core", "acceptstalefeeestimates is not supported on %s chain."),
};
