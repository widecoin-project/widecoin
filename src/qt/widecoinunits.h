...
#ifndef WIDECOIN_QT_WIDECOINUNITS_H
#define WIDECOIN_QT_WIDECOINUNITS_H
...
/** Widecoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class WidecoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit WidecoinUnits(QObject *parent);

    /** Widecoin units.
      @note Source: https://en.widecoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        WCN,
...
typedef WidecoinUnits::Unit WidecoinUnit;

#endif // WIDECOIN_QT_WIDECOINUNITS_H
