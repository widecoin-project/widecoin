...
{
    BOOST_CHECK(TestSplitHost("www.widecoincore.org", "www.widecoincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.widecoincore.org]", "www.widecoincore.org", 0));
    ...
    BOOST_CHECK(TestSplitHost("www.widecoincore.org:65536", "www.widecoincore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.widecoincore.org:0", "www.widecoincore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.widecoincore.org:", "www.widecoincore.org:", 0, false));
}
