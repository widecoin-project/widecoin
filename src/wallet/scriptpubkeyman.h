...
#ifndef WIDECOIN_WALLET_SCRIPTPUBKEYMAN_H
#define WIDECOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Widecoin Core wallet was originally a collection of unrelated private
...
#endif // WIDECOIN_WALLET_SCRIPTPUBKEYMAN_H
