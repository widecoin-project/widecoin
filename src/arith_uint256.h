...
#ifndef WIDECOIN_ARITH_UINT256_H
#define WIDECOIN_ARITH_UINT256_H
...
public:
     ...
     *
     * Widecoin only uses this "compact" format for encoding difficulty
...
#endif // WIDECOIN_ARITH_UINT256_H
