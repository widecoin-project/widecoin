...
#ifndef WIDECOIN_UTIL_SYSCALL_SANDBOX_H
#define WIDECOIN_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during widecoind initialization if Widecoin Core was compiled
...
#endif // WIDECOIN_UTIL_SYSCALL_SANDBOX_H
