...
* widecoin.conf: contains configuration settings for widecoind or widecoin-qt
* widecoind.pid: stores the process id of widecoind while running
...
* debug.log: contains debug information and general logging generated by widecoind or widecoin-qt
