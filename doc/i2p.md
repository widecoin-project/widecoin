...
application bridge enabled. The following routers are recommended for use with Widecoin Core:
...
The first time Widecoin Core connects to the I2P router, it automatically
...
`i2p_private_key` in the Widecoin Core data directory.  The persistent I2P
...
## Fetching I2P-related information from Widecoin Core
...
You can use the `getnodeaddresses` RPC to fetch a number of I2P peers known to your node; run `widecoin-cli help getnodeaddresses` for details.
...
It's important that the nodes of a popular application like Widecoin contribute
...
## Bundling I2P in a Widecoin application

Please see the "General Guidance for Developers" section in https://geti2p.net/en/docs/api/samv3
if you are developing a downstream application that may be bundling I2P with Widecoin.
