...
### Widecoin maintainers/release engineers, suggestion for writing release notes
...
### Build and sign Widecoin Core for Linux, Windows, and OS X:
...
Build output expected:
  ...
  4. OS X unsigned installer and dist tarball (`widecoin-${VERSION}-osx-unsigned.dmg`, `widecoin-${VERSION}-osx64.tar.gz`)
...
Add other gitian builders keys to your gpg keyring, and/or refresh keys.
    ...
    gpg --import widecoin/contrib/gitian-keys/*.pgp
    gpg --refresh-keys
...
Codesigner only: Sign the osx binary:
    ...
    transfer widecoin-osx-unsigned.tar.gz to osx for signing
...
Create (and optionally verify) the signed Windows binaries:
    ...
    mv build/out/widecoin-*win32-setup.exe ../widecoin-${VERSION}-win32-setup.exe
    popd
