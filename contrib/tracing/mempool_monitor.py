...
""" Example logging Widecoin Core mempool events using the mempool:added,
...
def main(widecoind_path):
    ...
    # to the tracepoints
    widecoind_with_usdts.enable_probe(probe="mempool:added", fn_name="trace_added")
    widecoind_with_usdts.enable_probe(probe="mempool:removed", fn_name="trace_removed")
    widecoind_with_usdts.enable_probe(probe="mempool:replaced", fn_name="trace_replaced")
    widecoind_with_usdts.enable_probe(probe="mempool:rejected", fn_name="trace_rejected")
