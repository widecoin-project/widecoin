...
# Extract options
function __fish_widecoin_tx_get_options
...
# Extract commands
function __fish_widecoin_tx_get_commands
...
complete \
    --command widecoin-tx \
    --condition "not __fish_widecoin_seen_cmd (__fish_widecoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_widecoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command widecoin-tx \
    --arguments "(__fish_widecoin_tx_get_commands)" \
    --no-files
