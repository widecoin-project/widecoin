...
complete --command widecoin-qt --no-files

# Extract options
function __fish_widecoinqt_get_options
...
complete \
    --command widecoin-qt \
    --arguments "(__fish_widecoinqt_get_options --nofiles)"
