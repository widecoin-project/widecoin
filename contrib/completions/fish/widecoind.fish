...
complete --command widecoind --no-files

# Extract options
function __fish_widecoind_get_options
...
complete \
    --command widecoind \
    --arguments "(__fish_widecoind_get_options --nofiles)"
