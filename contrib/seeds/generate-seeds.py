...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef WIDECOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define WIDECOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the widecoin network\n')
    ...
    g.write('#endif // WIDECOIN_CHAINPARAMSSEEDS_H\n')
