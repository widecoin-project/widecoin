...
def widecoin_cli(rpc_command_and_params):
    argv = [args.cmd] + args.widecoin_cli_args + rpc_command_and_params
    try:
...
if args.faucet.lower() == DEFAULT_GLOBAL_FAUCET:
    ...
    curr_signet_hash = widecoin_cli(['getblockhash', '1'])
...
if args.addr == '':
    ...
    args.addr = widecoin_cli(['getnewaddress', 'faucet', 'bech32'])
